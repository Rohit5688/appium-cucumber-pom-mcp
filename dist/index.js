            ...
            try {
                ...
                switch (request.params.name) {
                    ...
                    case "inspect_ui_hierarchy": {
                        ...
                        const result = await this.executionService.inspectHierarchy(projectRoot, args.xmlDump, args.screenshotBase64, args.stepHints);
                        const output = [
                            result.snapshot,
                            '',
                    ...
                    case "self_heal_test": {
                        ...
                        let xmlHierarchy = args.xmlHierarchy;
