 ...
 */
function createSafeConsole(logs) {
 ...
 */
export async function executeSandbox(script, apiRegistry, options = {}) {
    ...
    const sandboxGlobals = {
        ...
        encodeURI,
        decodeURI,
        Promise: class SandboxPromise extends Promise {
        },
