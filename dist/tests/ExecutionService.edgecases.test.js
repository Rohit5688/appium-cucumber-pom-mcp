    ...
    describe('Newline character injection prevention', () => {
        it('should reject specificArgs with newline character (\\n)', async () => {
            ...
            try {
                ...
                assert.ok(result.error?.includes('Invalid specificArgs'), `Expected specificArgs validation error, got: ${result.error}`);
            }
            finally {
                cleanupTest();
            }
    ...
    describe('overrideCommand validation', () => {
        it('should reject overrideCommand with semicolon', async () => {
            ...
            try {
                ...
                assert.ok(result.error?.includes('Invalid overrideCommand'), `Expected overrideCommand validation error, got: ${result.error}`);
            }
            finally {
                cleanupTest();
            }
        ...
        it('should accept valid overrideCommand without metacharacters', async () => {
            ...
            try {
                ...
                if (result.error) {
                    assert.ok(!result.error.includes('Invalid overrideCommand'), `Valid overrideCommand was rejected: ${result.error}`);
                }
            }
            finally {
                cleanupTest();
    ...
    describe('Empty string and whitespace handling', () => {
        it('should handle empty tags gracefully', async () => {
            ...
            try {
                ...
                if (result.error) {
                    assert.ok(!result.error.includes('Invalid tag expression'), `Empty tags should be valid, got: ${result.error}`);
                }
            }
            finally {
                cleanupTest();
        ...
        it('should handle whitespace-only tags gracefully', async () => {
            ...
            try {
                const result = await executionService['runTest'](testProjectRoot, { tags: '   ' });
                if (result.error) {
                    assert.ok(!result.error.includes('Invalid tag expression'), `Whitespace-only tags should be valid, got: ${result.error}`);
                }
            }
            finally {
                cleanupTest();
        ...
        it('should handle empty specificArgs gracefully', async () => {
            ...
            try {
                ...
                if (result.error) {
                    assert.ok(!result.error.includes('Invalid specificArgs'), `Empty specificArgs should be valid, got: ${result.error}`);
                }
            }
            finally {
                cleanupTest();
        ...
        it('should filter empty strings from split specificArgs', async () => {
            ...
            try {
                ...
                if (result.error) {
                    assert.ok(!result.error.includes('Invalid specificArgs'), `Multiple spaces should be handled, got: ${result.error}`);
                }
            }
            finally {
                cleanupTest();
    ...
    describe('Path traversal prevention in executable', () => {
        it('should reject executable with path traversal (..)', async () => {
            ...
            try {
                ...
                assert.ok(result.error?.includes('Invalid executable'), `Expected executable validation error, got: ${result.error}`);
            }
            finally {
                cleanupTest();
            }
        ...
        it('should accept absolute paths in executable', async () => {
            ...
            try {
                ...
                if (result.error) {
                    assert.ok(!result.error.includes('Invalid executable'), `Absolute path should be valid, got: ${result.error}`);
                }
            }
            finally {
                cleanupTest();
        ...
        it('should accept plain binary names', async () => {
            ...
            try {
                ...
                if (result.error) {
                    assert.ok(!result.error.includes('Invalid executable'), `Plain binary should be valid, got: ${result.error}`);
                }
            }
            finally {
                cleanupTest();
    ...
    describe('Combined attack vectors', () => {
        it('should reject multiple injection techniques combined', async () => {
            ...
            try {
                ...
                assert.ok(result.error?.includes('Invalid'), `Expected validation error, got: ${result.error}`);
            }
            finally {
                cleanupTest();
            }
        ...
        it('should validate all parameters before execution', async () => {
            ...
            try {
                ...
                assert.ok(result.error?.includes('Invalid specificArgs'), `Expected specificArgs error, got: ${result.error}`);
            }
            finally {
                cleanupTest();
            }
