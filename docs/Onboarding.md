...
> "Based on your analysis, run `upgrade_project` to ensure my directory structure supports the latest Appium-Cucumber standards (like the `utils/MobileGestures.ts` and `.AppForge/` brain). Make sure you don't overwrite my existing capabilities if they work."
