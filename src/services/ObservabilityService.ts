...
export class ObservabilityService {
  ...
  /** Writes viewer.html into mcp-logs/ on first run. Idempotent — skips if already present. */
...
// ─── Forge Session Viewer — single-file JSONL viewer, written once on first session start ───
